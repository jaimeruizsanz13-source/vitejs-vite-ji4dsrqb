...
const COMBOS = [
  ...
  },
  {
    ...
    risk: 'Medio',
    picks: [
      'Japón no pierde · 2.10',
      'EE.UU. gana · 2.20',
      'Marruecos empate o gana · 2.40',
    ],
  },
];
...
const sportColor = (sport: string) =>
  ({
    football: {
      bg: '#EDE9FE',
      color: '#5B21B6',
      bar: 'linear-gradient(90deg,#7C3AED,#3B82F6)',
    },
    basketball: {
      bg: '#FEF3C7',
      color: '#92400E',
    ...
    tennis: {
      bg: '#D1FAE5',
      color: '#065F46',
      bar: 'linear-gradient(90deg,#10B981,#3B82F6)',
    },
  }[sport] || {
    bg: '#EDE9FE',
    color: '#5B21B6',
...
export default function App() {
  ...
  const styles = {
    ...
    logoSpan: { color: '#A5F3A0' },
    tagline: { fontSize: 12, opacity: 0.8, marginTop: 2 },
    statsRow: {
    ...
    statLbl: { fontSize: 9, opacity: 0.8, marginTop: 1, color: '#fff' },
    content: {
      flex: 1,
      padding: 14,
            ...
            <div style={{ display: 'flex', gap: 5 }}>
              {(
                ...
                .map(([label, val]) => {
                  const active =
                    m.pick === label ||
                    (m.pick === '1X' && (label === '1' || label === 'X')) ||
                    (m.pick === 'X2' && (label === 'X' || label === '2'));
                  return (
                    <span
                      key={label}
                      style={{
            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  cursor: 'pointer',
                  fontSize: 20,
                  color: saved.includes(m.id) ? '#F59E0B' : '#DDD6FE',
                }}
              >
                {saved.includes(m.id) ? '★' : '☆'}
              </button>
    ...
    <div style={styles.app}>
      <div style={styles.header}>
        <div style={styles.logo}>
          Bet<span style={styles.logoSpan}>Mind</span>
        </div>
        <div style={styles.tagline}>
          {today.charAt(0).toUpperCase() + today.slice(1)} · Tu asistente
          deportivo
        </div>
      ...
      <div style={styles.content}>
            ...
            {COMBOS.map((c) => (
              ...
              >
                ...
                >
                  ...
                  <div
                    style={{ fontSize: 28, fontWeight: 900, color: '#D97706' }}
                  >
                    x{c.odds}
                  </div>
                </div>
        ...
        {tab === 'partidos' && (
          <div>
            ...
            >
              {(['all', 'football', 'basketball', 'tennis'] as Sport[]).map(
                (s) => (
                  <button
                    key={s}
                    onClick={() => setSport(s)}
            ...
            >
              {[
                ...
                >
                  ...
                  <div
                    style={{ fontSize: 11, color, opacity: 0.8, marginTop: 4 }}
                  >
                    {l}
                  </div>
                </div>
        ...
        {tab === 'perfil' && (
          <div>
            ...
            >
              ...
              >
                Desbloquea análisis ilimitados, alertas en tiempo real y
        ...
        >
          ...
          >
            ...
            >
              <span
                style={{
                  background: sportColor(selected.sport).bg,
                  color: sportColor(selected.sport).color,
                  fontSize: 11,
                  padding: '3px 10px',
                  borderRadius: 20,
                  fontWeight: 700,
            ...
            >
              ...
              <span
                style={{ color: '#9CA3AF', fontSize: 13, padding: '0 10px' }}
              >
                vs
              </span>
              <span style={{ flex: 1, textAlign: 'center' }}>
